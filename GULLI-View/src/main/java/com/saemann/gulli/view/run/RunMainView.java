...
//                SurfaceMeasurementRaster.measureSpilloutParticlesOnly=false;
//                SurfaceMeasurementRaster.minTravelLengthToMeasure=10;
//                ParticleSurfaceComputing2D.preventEnteringDryCell=false;
//                ParticleSurfaceComputing2D.gradientFlowForDryCells=true;
//                ParticleSurfaceComputing2D.slidealongEdges=false;
//                ParticleSurfaceComputing2D.dryFlowVelocity=0.05;
//                //Definition of special calculation parameters.
////                ParticlePipeComputing.spillOutToSurface = false;
////                ParticleSurfaceComputing2D.allowWashToPipesystem = false;
//            }
//
//            @Override
//            public void simulationSTEPFINISH(long loop, Object caller) {
////                System.out.println("SImulation Time: "+control.getThreadController().getSimulationTime());
////                if (control.getThreadController().getSimulationTime() > 30 * 60000) {
////                    control.getThreadController().stop();
////                }
//            }
//
//        });
