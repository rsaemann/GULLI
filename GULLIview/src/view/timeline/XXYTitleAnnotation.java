 ...
 * @since 1.0.11
 */
public class XXYTitleAnnotation extends AbstractXYAnnotation
     ...
     */
    public XXYTitleAnnotation(double x, double y, Title title) {
    ...
    public void draw(Graphics2D g2, XYPlot plot, Rectangle2D dataArea,
        ...
        if(rangeAxis==null){
            ...
            System.err.println("no Range (y) Axis define in Plot ");
            else{
                for (int i = 0; i < plot.getDatasetCount(); i++) {
                    if(plot.getRangeAxis(i)!=null)rangeAxis=plot.getRangeAxis(i);
                }
            }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof XXYTitleAnnotation)) {
            return false;
        }
        XXYTitleAnnotation that = (XXYTitleAnnotation) obj;
